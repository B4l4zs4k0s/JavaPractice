...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.print("I choose you, " + returnEffective(pokemonListOfAsh, wildPokemon));
    }
    ...
    private static String returnEffective(List<Pokemon> pokemonListOfAsh, Pokemon wildPokemon) {
        String name = "";
